...
L["%s finished objectives: %s"]           = "%s a terminé les objectifs : %s"
L["%s completed: %s"]                     = "%s terminée : %s"
...
L["Everyone has finished: %s"]            = "Tout le monde a terminé : %s"
...
L["Show a banner on screen when a group member finishes all objectives on a quest."]   = "Affiche une bannière lorsqu'un membre du groupe termine tous les objectifs d'une quête."
...
L["Test Finished"]                         = "Tester Terminée"
L["Display a demo banner and local chat preview for the 'Quest finished objectives' event."] = "Affiche une bannière de démonstration et un aperçu du chat local pour l'événement 'Objectifs de quête terminés'."
L["Test Completed"]                        = "Tester Accomplie"
L["Display a demo banner and local chat preview for the 'Quest turned in' event."] = "Affiche une bannière de démonstration et un aperçu du chat local pour l'événement 'Quête remise'."
...
L["Test All Finished"]                     = "Tester tout terminé"
L["Display a demo banner for the 'Everyone has finished' purple notification. No chat preview (this event never generates outbound chat directly)."] = "Affiche une bannière de démonstration pour la notification violette 'Tout le monde a terminé'. Pas d'aperçu de chat (cet événement ne génère jamais de chat sortant directement)."
