...
L["%s finished objectives: %s"]           = "%s concluiu os objetivos: %s"
...
L["Show a banner on screen when a group member finishes all objectives on a quest."]   = "Exibe um banner quando um membro do grupo conclui todos os objetivos de uma missão."
...
L["Test Finished"]                         = "Testar Encerrada"
L["Display a demo banner and local chat preview for the 'Quest finished objectives' event."] = "Exibe um banner de demonstração e prévia do chat local para o evento 'Objetivos de missão concluídos'."
L["Test Completed"]                        = "Testar Completada"
