...
L["Everyone has finished: %s"]            = "Все выполнили задачи: %s"
...
L["Show a banner on screen when a group member finishes all objectives on a quest."]   = "Показывает баннер на экране, когда участник группы выполняет все цели задания."
...
L["Test Finished"]                         = "Тест завершения"
L["Display a demo banner and local chat preview for the 'Quest finished objectives' event."] = "Показывает демонстрационный баннер и локальный предпросмотр чата для события 'Цели задания выполнены'."
L["Test Completed"]                        = "Тест выполнения"
...
L["Test All Finished"]                     = "Тест все выполнили задачи"
L["Display a demo banner for the 'Everyone has finished' purple notification. No chat preview (this event never generates outbound chat directly)."] = "Отображает демонстрационный баннер для фиолетового уведомления 'Все выполнили задачи'. Без предварительного просмотра чата (это событие никогда не генерирует исходящий чат напрямую)."
