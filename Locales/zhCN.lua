...
L["%s finished objectives: %s"]           = "%s 完成了所有目标：%s"
...
L["Show a banner on screen when a group member finishes all objectives on a quest."]   = "队员完成任务所有目标时在屏幕上显示横幅。"
...
L["Test Finished"]                         = "测试已结束"
L["Display a demo banner and local chat preview for the 'Quest finished objectives' event."] = "为\"任务目标已完成\"事件显示演示横幅和本地聊天预览。"
L["Test Completed"]                        = "测试已完成"
