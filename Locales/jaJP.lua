...
L["%s finished objectives: %s"]           = "%s が目標達成: %s"
L["%s completed: %s"]                     = "%s が達成: %s"
...
L["Show a banner on screen when a group member finishes all objectives on a quest."]   = "グループメンバーがクエストの全目標を完了したときにバナーを表示します。"
...
L["Test Finished"]                         = "完了テスト"
L["Display a demo banner and local chat preview for the 'Quest finished objectives' event."] = "「クエスト目標完了」イベントのデモバナーとローカルチャットプレビューを表示します。"
L["Test Completed"]                        = "達成テスト"
L["Display a demo banner and local chat preview for the 'Quest turned in' event."] = "「クエスト達成」イベントのデモバナーとローカルチャットプレビューを表示します。"
L["Test Failed"]                           = "失敗テスト"
