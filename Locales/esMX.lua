...
L["Everyone has completed: %s"]           = "Todos completaron: %s"
...
L["Display a demo banner for the 'Everyone has completed' purple notification. No chat preview (this event never generates outbound chat directly)."] = "Muestra un banner de demostración para la notificación morada 'Todos completaron'. Sin vista previa de chat (este evento nunca genera chat saliente directamente)."
