...
L["Show a banner on screen when a group member finishes all objectives on a quest."]   = "그룹 구성원이 퀘스트의 모든 목표를 완료할 때 화면에 배너를 표시합니다."
...
L["Test Finished"]                         = "종료 테스트"
L["Display a demo banner and local chat preview for the 'Quest finished objectives' event."] = "'퀘스트 목표 완료' 이벤트에 대한 데모 배너와 로컬 채팅 미리보기를 표시합니다."
L["Test Completed"]                        = "완료 테스트"
